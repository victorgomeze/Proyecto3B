module Spree
  class Address < Spree::Base
    ...
    with_options presence: true do
      validates :firstname, format: { with: /\A[a-zA-Z]+\z/, message: "Solo se aceptan letras" } 
      validates :lastname, format: { with: /\A[a-zA-Z]+\z/, message: "Solo se aceptan letras" }
      validates :address1 
      validates :city, format: { with: /\A[a-zA-Z]+\z/, message: "Solo se aceptan letras" } 
      validates :country
      validates :zipcode, format: { with: /\A[0-9]+\z/, message: "Solo se aceptan numeros" }
      validates :phone, format: { with: /\A[0-9]+\z/, message: "Solo se aceptan numeros" }
