...
class RegistrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registro" do
    assert_difference('Registro.count') do
      post registros_url, params: { registro: { datetime: @registro.datetime, fecha: @registro.fecha, hora_ingreso: @registro.hora_ingreso, hora_salida: @registro.hora_salida } }
    end
  ...
  test "should update registro" do
    patch registro_url(@registro), params: { registro: { datetime: @registro.datetime, fecha: @registro.fecha, hora_ingreso: @registro.hora_ingreso, hora_salida: @registro.hora_salida } }
