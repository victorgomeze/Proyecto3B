...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { nombre: @producto.nombre, precio_compra: @producto.precio_compra, precio_venta: @producto.precio_venta, stock_act: @producto.stock_act, stock_min: @producto.stock_min } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { nombre: @producto.nombre, precio_compra: @producto.precio_compra, precio_venta: @producto.precio_venta, stock_act: @producto.stock_act, stock_min: @producto.stock_min } }
